...
Relational Databases store data in tables like a high functioning spreadsheet. SQL is a language that allows users to modify, manipulate, and query data from the database.

2. Why do tables need a Primary Key?
Primary Keys are used to identify the type of data stored in the table.

3. What is the name given to a table column that references the Primary Key on another table?
This is the foreign Key

4. What do we need in order to have a _many to many_ relationship between two tables?
We would need an intermediary table that contains the primary keys of both tables.
